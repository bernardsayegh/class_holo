...
Om0_holo = 0.325   # v5 Model B posterior mean
...
ax.plot(z_range, OL_holo_curve, color='blue', linewidth=3.0, label=r'Holographic Model ($\Omega_m=0.325$, v5 fit)')
...
ax.errorbar(z_data, OL_data, yerr=yerr_data, fmt='o', color='orange', ecolor='orange', 
            markersize=9, capsize=5, elinewidth=2, markeredgewidth=2, label='H(z) data (BOSS/eBOSS/WiggleZ; Planck H0 at z=0)')
